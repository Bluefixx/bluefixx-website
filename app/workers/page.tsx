...
export default function WorkersPage() {
  return (
    <div className="w-full flex flex-col bg-white">
      {/* Hero Section */}
      <section className="w-full py-[48px] px-4 md:px-[64px]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full aspect-video md:aspect-[4/3] lg:aspect-square bg-[#F2F4F6] rounded-[20px] overflow-hidden border border-black/5">
