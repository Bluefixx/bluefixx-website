  ...
  return (
    <div className="w-full flex flex-col bg-white">
      ...
      >
        ...
        {/* Hero Content */}
        <div className="relative z-10 max-w-4xl flex flex-col text-left">
          {/* Heading */}
      ...
      <section className="bg-[#F7F9FB] py-[96px] md:py-[120px] px-6 md:px-12 lg:px-[64px] flex flex-col items-center">
        {/* Intro Tag */}
